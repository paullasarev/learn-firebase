...
import 'package:flutter_firebase/src/screens/tab_home/tab_home_view.dart' show tabHomeView, tabs;
...
class TabHomePage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tabController = useTabController(initialLength: tabs.length, initialIndex: 0);
